...
function populateAccommodationResults() {
  ...
  // get div from html
  const accommodationResults = document.getElementById("accommodation-results");
  ...
  // TO FIX - ACCOMMS DETAILS DIV SHOULD BE INSIDE THE CARD
  accommodations.forEach(accommodation => {
    ...
    <div class="accommodation-card">
      ...
      <div class="swiper">
          ...
          <div class="swiper-wrapper">
                  <div class="swiper-slide"><img src="${accommodation.image}" alt="${accommodation.propertyName} image 1" class="accommodation-item-image" data-id="${accommodation.id}"></div>
                  <div class="swiper-slide"><img src="${accommodation.image}" alt="${accommodation.propertyName} image 1" class="accommodation-item-image" data-id="${accommodation.id}"></div>
                  <div class="swiper-slide"><img src="${accommodation.image}" alt="${accommodation.propertyName} image 1" class="accommodation-item-image" data-id="${accommodation.id}"></div>
              </div>
      ...
      <div class="accommodation-details">
          <-- accomm. details top row -->
          <div class="accomm-details-top-container">

              <-- accomm. detail headers container -->
              <div class="accomm-details-header-container">
                  <h3 class="green-header">${accommodation.propertyName}</h3>
                  <h4 class="green-header">${accommodation.address}</h3>
              </div>

              <-- accomm. detail ratings container -->
    ...
    accommodationResults.innerHTML += accommodationCard;
  });
